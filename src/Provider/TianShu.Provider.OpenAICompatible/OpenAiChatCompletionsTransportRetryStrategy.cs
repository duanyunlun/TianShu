...
/// <summary>
/// OpenAI-compatible Chat Completions transport 的重试策略。
/// Retry strategy for OpenAI-compatible Chat Completions transport.
/// </summary>
public sealed class OpenAiChatCompletionsTransportRetryStrategy : IProviderResponsesTransportRetryStrategy
{
    /// <inheritdoc />
